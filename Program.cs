...
// List<string> listaDasBandas = new List<string> {"U2", "The Beatles", "Callypso"};
...
void ExibirOpcoesDoMenu() {
  ...
  switch (opcaoEscolhidaNumerica)
  {
    ...
    case 4: ExibirMedia();
      break;
    case -1: Console.WriteLine("Até a próxima!", opcaoEscolhidaNumerica);
      break;
...
void AvaliarBanda() {
  ...
  if(bandasRegistradas.ContainsKey(nomeDaBanda)) {
    ...
    Console.WriteLine("Digite qualquer tecla paravoltar ao menu principal.");
    Console.ReadKey();
    Console.Clear();
    ExibirOpcoesDoMenu();
  }
